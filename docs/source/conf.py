# -*- coding: utf-8 -*-
#
# Neet documentation build configuration file, created by
...
latex_documents = [
    (master_doc, 'Neet.tex', u'Neet Documentation',
     u'ELIFE', 'manual'),
]
...
man_pages = [
    (master_doc, 'neet', u'Neet Documentation',
     [author], 1)
]
